...
function denyRootPath(req, res) {
    helpers.controllers.sendErrorMessage(res, "You must request a specific class with its ID, e.g. '/classes/1234'.", 403);
}
...
function getClassById(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield classesService.getClassById(req.params.classId);
